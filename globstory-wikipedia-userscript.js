// ==UserScript==
// @name         GlobStory Wikipedia Integration
// @namespace    https://globstory.it/
// @version      1.0
// @description  Add an interactive historical map to Wikipedia pages with geographical and temporal highlights
// @author       GlobStory
...
(function() {
    ...
    async function updateMapLocation(placeName) {
        try {
            ...
            if (data.length > 0) {
                ...
                const mapZoom = zoomLevels[type] || 6; // Default zoom level
